...
class TMDBService {
    ...
    private let posterUrlPrefix = "https://image.tmdb.org/t/p/w500"
    private let dataRequestUrlPrefix = "https://api.themoviedb.org"
    ...
    func request(requestType: RequestType, page:Int? = nil,
        ...
        if requestType == .dummy {
            guard let result = try? MDBRequest.load(fromString: dummyData) else {
